...
<div class="content">
  ...
  <h1 style="text-align: center;font-family:Times New Roman;text-decoration: underline;font-size:44px;color:white; "> Payment File Attachment </h1>
  <form style="text-align=center">
    ...
    <p style="text-indent: 80px"> Email : <input type="text" name="email" > <p>
      ...
      <p style="text-indent: 12px">Browse File to Attach Here : <input type="submit" name="upload" value="UPLOAD File" >
